...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        scroller: {
          ...
          to: {
            transform: "translate3d(0, calc(var(--scroll-end, -20em)), 0)",
          },
        },
        scroller2: {
          from: { transform: "translate3d(0, var(--scroll-start, 10em), 0)" },
    ...
    `,
        ...
        "blue-top":
          "0 -10px 20px -2px rgba(59, 130, 246, 0.5), 0 -6px 12px -4px rgba(59, 130, 246, 0.5)",
        "blue-bottom":
          "0 4px 6px -1px rgba(59, 130, 246, 0.5), 0 6px 4px -2px rgba(59, 130, 246, 0.5)",
