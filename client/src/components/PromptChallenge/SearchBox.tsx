...
export default function SearchBox() {
	...
	return (
		<section className='p-8'>
			<div
				className='mx-auto 2xl:max-w-7xl py-24 items-center lg:py-24 relative w-full 
			...
			>
				<div className='text-center max-w-xl md:mx-auto'>
					...
					<p className='mt-5 text-white'>
						Feel free to write your own search terms, or kick back and leverage
						the power of AI and use one of our suggested queries, just for you
					</p>
