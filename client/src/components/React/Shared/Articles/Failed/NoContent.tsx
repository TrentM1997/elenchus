...
export default function NoContent(): JSX.Element | null {
    ...
    return (
        <div
            className="opacity-0 animate-fade-blur animation-delay-400ms transition-opacity"
        >
...
function ExtractionServiceDown(): JSX.Element | null {
    ...
    return (
        <div className="w-fit h-fit flex flex-col justify-center items-center gap-y-8 py-24">
            ...
            <h1 className="w-fit text-zinc-500 mt-6 font-light tracking-tight 2xl:text-3xl">
                Article extraction service is currently down
            </h1>
            <p className="text-zinc-500 font-light tracking-tight text-sm 2xl:text-xl">
