...
export default function LoginForm({ acceptedInput, setUserPassword, setUserEmail, validEmail, submitAuth }: LoginFormProps) {

    return (
        <form autoComplete="off">
            {status === "failed" && <p className="text-zinc-400 font-light lg:text-2xl -translate-y-6">
