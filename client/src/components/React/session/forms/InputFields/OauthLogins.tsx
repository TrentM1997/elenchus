    ...
    <div className="flex flex-col text-center space-y-2">
      <div className="py-3 relative">
        ...
        <div className="flex relative justify-center">
          <span className="text-sm bg-white px-2 text-black">
            Or continue with
          </span>
        </div>
      </div>
      <button
        className="text-sm py-2 px-4 border focus:ring-2 rounded-full border-zinc-100 bg-zinc-100 hover:bg-zinc-50 duration-200 focus:ring-offset-2 gap-3 focus:ring-black text-black w-full inline-flex items-center justify-between ring-1 ring-transparent h-10"
        type="button"
      >
        <span>
          <svg
