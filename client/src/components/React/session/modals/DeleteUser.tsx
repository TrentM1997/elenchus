  ...
  return (
    ...
    >
      <div className="lg:min-w-0 lg:flex-1 max-w-sm mx-auto">
        <p className="text-white lg:text-3xl font-light tracking-tight">
          Delete Account
        </p>
        <p className="mt-4">
        ...
        {deleteStatus === "idle" && !showInput && (
          <DeleteAccountButtons setShowInput={setShowInput} />
        )}
...
function DeleteAccountButtons({ setShowInput }: any) {
  const dispatch = useDispatch();
