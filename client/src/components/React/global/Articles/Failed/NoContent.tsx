...
function ExtractionServiceDown(): JSX.Element | null {
    ...
    return (
        <div className="w-fit h-fit flex flex-col justify-center items-center gap-y-8 md:py-24 opacity-100">
            <div className="h-16 w-16 flex items-center justify-center text-zinc-500 md:text-zinc-600">
            ...
            <h1 className="w-full text-center text-zinc-400 md:text-zinc-500 antialiased mt-6 text-3xl font-light tracking-tight 2xl:text-3xl">
                Article extraction service is currently down
            </h1>
            <p className="md:text-zinc-500 text-zinc-400 antialiased font-light text-center tracking-tight text-lg md:text-sm 2xl:text-xl text-wrap w-auto">
