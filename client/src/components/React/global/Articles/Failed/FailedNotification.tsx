...
export default function FailedNotification({ notification }) {
  ...
  return (
    ...
    >
      {/* Main content */}
      <div
        className="xl:w-5/6 box-border flex gap-x-2 pl-2 pb-6 pt-2 pr-16 sm:pr-0 sm:pl-0 sm:pt-0 sm:pb-0 
          ...
          <div className="flex gap-2 h-auto items-start xs:w-full md:w-3/4 lg:w-5/6 box-border">
            ...
            <p className="text-white text-sm md:text-sm block md:hidden">
              <span className="text-sm font-light tracking-tight text-white">
                <em>{notification.source} article:</em>
              </span>
      ...
      >
        <a
          ...
          className="text-base text-black md:group-hover:text-black md:text-white sm:text-xs"
          target="_blank"
        >
          Visit Source
        </a>
