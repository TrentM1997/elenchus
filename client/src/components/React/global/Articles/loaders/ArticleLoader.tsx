        ...
        <header className="w-auto h-auto mx-auto flex flex-col items-center justify-center">
         ...
         bg-[length:200%_100%] bg-clip-text text-transparent animate-shimmer pb-8"
          ...
          <div className="w-full h-24 flex items-center justify-center">
            <p
              className={`text-zinc-400 opacity-0 ${showWaitCaution ? "animate-fade-blur" : ""} ease-soft font-light tracking-tight text-xs md:text-base text-center text-wrap w-4/5`}
            >
              This process may take a minute or two while we extract and format
              each article for reading.
            </p>
          </div>
        </header>
      </div>
...
function ScrapeProgress({
  ...
  return (
    <div className="flex items-center justify-center p-3 w-auto h-auto rounded-lg bg-white/5">
      <p
        aria-live="polite"
        className="text-zinc-400 font-light tracking-tight text-sm"
      >
        Progress {progress}
      </p>
    </div>
