            ...
            <div className="w-auto h-auto">
              {activeSession ? (
                <svg
                  ...
                  className="icon icon-tabler icons-tabler-outline text-white/80 icon-tabler-logout-2"
                >
                ...
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="icon icon-tabler text-white/80 icons-tabler-outline icon-tabler-login-2"
                >
                  <path stroke="none" d="M0 0h24v24H0z" fill="none" />
