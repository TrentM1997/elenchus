...
export default function StepsEditor({ setterFunction, context }) {
  ...
  return (
    <div className="w-full h-full box-border mx-auto">
      <div className="control-group w-full flex px-1 bg-ebony/50">
        <div className="button-group w-full mx-auto text-white flex gap-x-3 py-1">
          <button
            onClick={() =>
              editor.chain().focus().toggleHeading({ level: 1 }).run()
            }
          >
            <div className="max-h-7 max-w-7 p-1 group shadow-thick  bg-mirage hover:bg-white transition-all duration-200 ease-in-out rounded-md cursor-pointer">
              <svg
                className="text-white box-border group-hover:text-black transition-all duration-200 ease-in-out"
              ...
              >
                ...
                >
                  <g transform="scale(10.66667,10.66667)">
                    <path d="M2,4v16h3v-7h6v7h3v-16h-3v6h-6v-6zM21.65625,4l-5.65625,2.11523v2.625l3,-0.95508v12.21484h3v-16z" />
                  </g>
                </g>
              </svg>
            </div>
          ...
          >
            <div className="max-h-7 max-w-7 p-1 group shadow-thick bg-mirage hover:bg-white transition-all duration-200 ease-in-out rounded-md cursor-pointer">
              ...
              >
                ...
                >
                  <g transform="scale(10.66667,10.66667)">
                    <path d="M1,5v14h3v-6h4v6h3v-14h-3v5h-4v-5zM17.91992,5c-0.928,0 -1.76948,0.20342 -2.52148,0.60742c-0.752,0.404 -1.34067,0.96464 -1.76367,1.68164c-0.423,0.717 -0.63477,1.4987 -0.63477,2.3457v0.36523h3l0.05859,-0.50977c0,-1.49 1.00416,-2.02539 1.78516,-2.02539c1.625,0 1.75,1.22436 1.75,1.81836c0,0.733 -0.78005,1.72375 -1.87305,2.96875l-4.7207,4.66211v2.08594h10v-2.46484h-5.51758c0,0 3.41675,-3.76017 3.84375,-4.32617c0.426,-0.566 0.74136,-1.10609 0.94336,-1.62109c0.202,-0.515 0.30273,-1.04489 0.30273,-1.58789c0,-1.289 -0.40398,-2.2778 -1.20898,-2.9668c-0.805,-0.689 -1.95236,-1.0332 -3.44336,-1.0332z" />
                  </g>
                </g>
              </svg>
            </div>
          ...
          >
            <div className="max-h-7 max-w-7 group p-1 shadow-thick  bg-mirage hover:bg-white transition-all duration-300 ease-in-out rounded-md cursor-pointer">
              <svg
                className="text-white box-border group-hover:text-black transition-all duration-200 ease-in-out"
                xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink"
              ...
              >
                ...
                >
                  <g transform="scale(10.66667,10.66667)">
                    <path d="M3.99805,3c-1.1,0 -1.98828,0.9 -1.98828,2l-0.00977,11.99805c0,1.105 0.895,2.00195 2,2.00195h1.99805h0.00195v4l3.99805,-4h10c1.1,0 2,-0.9 2,-2v-12c0,-1.1 -0.9,-2 -2,-2zM3.99805,5h16.00195v12h-14.00195h-1.99805zM7,8v4h2l-2,3h2l2,-3v-1v-3zM13,8v4h2l-2,3h2l2,-3v-1v-3z" />
                  </g>
                </g>
              </svg>
            </div>
          ...
          >
            <div className="max-h-7 max-w-7 group p-1 shadow-thick  bg-mirage hover:bg-white transition-all duration-200 ease-in-out rounded-md cursor-pointer">
              <svg
                className="text-white box-border group-hover:text-black transition-all duration-200 ease-in-out"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 48 48"
          ...
          >
            <div className="max-h-7 shadow-thick group max-w-7 p-1 bg-mirage hover:bg-white transition-all duration-200 ease-in-out rounded-md cursor-pointer">
              <svg
                className="text-white box-border group-hover:text-black transition-all duration-200 ease-in-out"
                xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          >
            <div className="max-h-7 shadow-thick  max-w-7 p-1 group bg-mirage hover:bg-white transition-all duration-200 ease-in-out rounded-md cursor-pointer">
              <svg
                className="text-white box-border group-hover:text-black transition-all duration-200 ease-in-out"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 48 48"
