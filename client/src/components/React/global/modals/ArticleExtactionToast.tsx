...
export default function ArticleExtractionToast(): JSX.Element | null {
  ...
  return (
    <div
      className="w-88 h-88 lg:h-88 lg:w-96 rounded-3xl p-6 bg-black ring-2 ring-white/20 opacity-0 
    ...
    <div className="bg-white rounded-3xl flex flex-col items-center justify-center p-4">
      ...
      <div className="w-auto h-auto p-6">
        <h1 className="text-black font-light tracking-tight text-base text-wrap">
          Article extraction is temporarily unavailable. We're switching
          providers now. You can still search and visit sources. Article
          extraction will resume soon.
        </h1>
      </div>
    </div>
  );
