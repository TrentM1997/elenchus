...
export default function HelpButton({ info }) {
  ...
  return (
    <div className="w-full h-full pb-1 flex items-center relative group justify-end">
      <HelpTooltip />
      <div
        onClick={handleExpand}
        className="z-30 hover:cursor-pointer rounded-full xl:max-w-6 xl:max-h-6 max-w-5 max-h-5 bg-white/5"
      >
        <svg
