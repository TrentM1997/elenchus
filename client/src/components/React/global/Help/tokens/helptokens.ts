...
import { WizardStep } from "@/state/Reducers/Investigate/pov/types";
...
const SummaryHelp: Help[] = [
  {
    ...
    explanation:
      "On the panel of buttons at the bottom of the screen (bottom left if using a desktop) click the blue checkmark button when you're finished reading",
  },
];
...
const ResearchHelp: Help[] = [
  {
    heading: "Help",
    explanation:
      "Select whether you felt the Idea or premises you investigated were supported by the evidence you could find",
  },
];
...
export const helpInfo = {
  ...
  premises: Step4Help,
  final: Step5Help,
} satisfies Record<WizardStep, Help[]>;
