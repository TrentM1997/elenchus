...
const ChartingFeatures: React.FC = (): JSX.Element | null => {


    return (
        <section className="lg:p-8 opacity-0 animate-fade-in animation-delay-300ms ease-soft">
...
export default React.memo(ChartingFeatures);