...
function Challenge() {
    ...
    return (
        <section className="lg:p-8 p-4 opacity-0 animate-fade-in animation-delay-300ms ease-soft">
            <div className="px-8 py-12 lg:py-0 mx-auto md:px-12 lg:px-16 xl:px-24 lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl">
