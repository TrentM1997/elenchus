export default function AboutHeader() {
    ...
    return (
        <section className="p-4 lg:p-8">
            <div className="opacity-0 animate-fade-skew animation-delay-300ms mx-auto 2xl:max-w-5xl py-24 lg:px-16 md:px-12 px-2 items-center lg:pt-24 relative w-full bg-gradientdown rounded-4xl">
