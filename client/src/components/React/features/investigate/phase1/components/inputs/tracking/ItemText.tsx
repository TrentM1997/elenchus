...
function ItemText({
  ...
  return (
    <div
      className={`${itemStep === 2 ? "w-full items-center" : "basis-full"} 2xl:h-[68px] xl:h-[68px] lg:h-[64px] md:h-[54px] flex flex-col gap-y-2`}
    >
      <div
        className={`
      ...
      >
        <p
          className={` ${
            step === itemStep - 1 ? "text-blue-400" : "text-blue-400"
          } 
