...
function InputOptions() {
  ...
  const searchBS = () => {
    dispatch(choosePath('BlueSky Feed'));
  };
  ...
  return (
    <section className="lg:p-8 opacity-0 animate-fade-in animation-delay-300ms">
      <div className="mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl py-6 lg:px-16 md:px-12 px-8 xl:px-36 items-center md:py-16 lg:py-24 relative w-full">
        <div>
                  ...
                  <div className="mt-8 w-full">
                    <button
                      ...
                      className="text-sm py-2 w-full px-4 border focus:ring-2 rounded-full border-transparent group
                          ...
                          hover:text-white  ring-1 ring-transparent flex items-center justify-center
                          gap-4"
                    >
