...
export default function InvestigationWorkSpace() {
    ...
    const idea: string | null = useSelector((s: RootState) => s.investigation.pov.idea);
    ...
    return (
        ...
        >
            ...
            <Suspense key={'Hero-boundary'} fallback={<DelayedFallback key={'delayed-hero-loader'} delay={300}> <ComponentLoader key={'hero-container-skeleton'} /></DelayedFallback>} >
                {(phase !== 'Initial') &&
