...
function IncrementPage({ increment }: IncrementPage): JSX.Element | null {
    ...
    return (
        <button
            ...
            className="rounded-r-3xl text-white rounded-l-none
                 ...
                 ">
            <svg className={`text-white group-hover:text-black w-4 h-4 lg:w-6 lg:h-6`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="100%" height="100%">
