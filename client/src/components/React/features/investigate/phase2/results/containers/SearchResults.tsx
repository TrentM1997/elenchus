...
import { getPages } from "@/state/Reducers/Investigate/articles/SearchResults";
import { formPages } from "@/lib/helpers/formatting/Presentation";
...
export default function SearchResults() {
  ...
  const renderOptions =
    Array.isArray(articleOptions) && articleOptions.length > 0;
  ...
  return (
    ...
    >
      <div className="h-full w-full flex flex-col justify-start items-center mx-auto relative">
        ...
        {renderFallback && <SearchFailed key="no-results" />}
      </div>
