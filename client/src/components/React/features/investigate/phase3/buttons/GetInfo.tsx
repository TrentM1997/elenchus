    ...
    return (
        <div className={`${failedExtraction ? 'pointer-events-none opacity-30' : 'pointer-events-auto opacity-100 lg:hover:bg-border_gray'}
            ...
            <button
                ...
                <div className="absolute p-1 bg-white z-50 opacity-0 transition-opacity duration-200 ease-soft delay-500 md:group-hover:opacity-100 bottom-[3.3rem] -left-5
