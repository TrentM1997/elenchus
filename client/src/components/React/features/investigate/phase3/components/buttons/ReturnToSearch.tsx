...
function BackArrow(): JSX.Element {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={'100%'} height={'100%'} viewBox="0 0 24 24" fill="currentColor"
            className="icon icon-tabler icons-tabler-filled icon-tabler-circle-arrow-left text-white lg:group-hover:scale-125
        lg:group-hover:text-blue-500 transition-all ease-soft duration-300 delay-200
