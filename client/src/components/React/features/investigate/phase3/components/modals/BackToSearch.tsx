...
export default function BackToSearch(): JSX.Element {
  ...
  return (
    <div
      className="z-50 opacity-0 animate-fade-blur animation-delay-400ms transform-gpu will-change-transform
    ...
    >
      <div className="lg:min-w-0 lg:flex-1 w-full mx-auto">
        ...
        <p className="mt-4">
          ...
          <span className="text-base font-medium text-zinc-400/80">
            You will lose the articles you just loaded.
          </span>
          <br></br>
          <span className="text-base font-medium text-zinc-400/80">
        ...
        <div className="inline-flex flex-no-wrap gap-x-4 items-center mt-8 w-full">
          <button
            ...
            type="button"
            className="text-base min-w-36 py-2 w-full px-4 border focus:ring-2 rounded-full border-transparent bg-white hover:bg-white/10 text-black duration-200 focus:ring-offset-2 focus:ring-white hover:text-white inline-flex items-center justify-center ring-1 ring-transparent"
          >
            No
          </button>
          <button
            ...
            type="button"
            className="text-base py-2 min-w-36 w-full px-4 border focus:ring-2 rounded-full border-transparent bg-white hover:bg-white/10 text-black duration-200 focus:ring-offset-2 focus:ring-white hover:text-white inline-flex items-center justify-center ring-1 ring-transparent"
          >
            Yes
          </button>
        </div>
