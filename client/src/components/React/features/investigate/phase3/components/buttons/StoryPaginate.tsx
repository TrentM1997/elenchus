...
export default function StoryPaginate({
  ...
  return (
    <div className="z-20 flex relative">
      ...
      >
        <svg
          className={`text-white group-hover:text-black w-4 h-4`}
      ...
      <button
        onClick={() => increment()}
        className="rounded-r-3xl text-white rounded-l-none border border-white/10 py-2 px-3 text-center text-sm transition-all
