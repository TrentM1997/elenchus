...
export default function ButtonHoverTooltip({
  description,
}: ButtonHoverTooltip): JSX.Element | null {
  return (
    <div
      className="absolute pointer-events-none p-0.5 bg-white z-50 opacity-0 transition-opacity will-change-[opacity] w-16 h-auto
        delay-700 duration-200 ease-soft md:group-hover:opacity-100 bottom-[3.3rem] -left-3
    ...
    >
      <p className="text-black text-[0.80rem]">{description}</p>
    </div>
  );
}
