...
export default function ButtonHoverTooltip({ description }: ButtonHoverTooltip): JSX.Element | null {
    ...
    return (
        <div className="absolute pointer-events-none p-1 bg-white z-50 opacity-0 transition-opacity delay-1000 duration-200 ease-soft md:group-hover:opacity-100 bottom-[3.3rem] -left-4
