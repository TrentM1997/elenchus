      ...
      {excess && !isMobile && (
        <div className="lg:inline-flex items-center inline-flex lg:col-start-4 lg:ml-auto lg:px-2 mb-4 order-last space-x-2">
          <button
            ...
            type="button"
            className={`bg-white/5 hover:bg-white/10 focus:bg-transparent 
          ...
          <button
            ...
            type="button"
            className="bg-white/5 hover:bg-white/10 focus:bg-transparent rounded-2xl inline-flex items-center text-center text-white p-4 ring-1 ring-white/10 group"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={`h-4 w-4 ${excess ? "text-white" : "text-zinc-600"}  md:group-hover:text-white`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2}
