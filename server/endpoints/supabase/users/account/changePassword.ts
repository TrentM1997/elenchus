...
import type { ChangePasswordSuccess, ChangePasswordError } from '../../../../types/interfaces.js';
...
export const changePassword = wrapAsync(async (req: Request, res: Response<ChangePasswordSuccess | ChangePasswordError>): Promise<void> => {
